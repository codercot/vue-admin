  ...
  <div class="home">
    <el-form :inline="true" class="demo-form-inline" v-model="tmForm">
      <el-form-item label="一级分类">
        <el-select placeholder="请选择" v-model="tmForm.category1id" @change="handle1" :disabled="show">
          <el-option :label="c1.name" :value="c1.id" v-for="(c1, index) in list1" :key="c1.id"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="二级分类">
        <el-select placeholder="请选择" v-model="tmForm.category2id" @change="handle2" :disabled="show">
          <el-option :label="c2.name" :value="c2.id" v-for="(c2, index) in list2" :key="c2.id"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item label="三级分类">
        <el-select placeholder="请选择" v-model="tmForm.category3id" @change="handle3" :disabled="show">
