<template>
  <div class="top">
    <div class="card-top">{{ title }} <svg t="1683964903178" class="icon" viewBox="0 0 1024 1024" version="1.1"
        xmlns="http://www.w3.org/2000/svg" p-id="3936" width="16" height="16">
        <path
        ...
        <path
          ...
          fill="#2c2c2c" p-id="3938"></path>
        <path d="M511.357364 296.458969m-45.080731 0a44.054 44.054 0 1 0 90.161463 0 44.054 44.054 0 1 0-90.161463 0Z"
          fill="#2c2c2c" p-id="3939"></path>
      </svg></div>
